...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 15 11:40:08 2019

@author: kendalljohnson
"""

# Whole Thing 6
# We hope to demonstaight the Heart rate being read and having the M.L. algorhythem activated and determine if the indiviual has been stimulated or not
...
count = df.values[:,0]
HR = df.values[:,1]                 # Heart Rate in beats per minute
IBI = df.values[:,2]                # IBI is a varible giving from hearts beat anaylsis that is a great indicator of a person's stimulus  # Ignore first 10 secs
HR_size = HR.size
...
df1 = pd.read_csv('HR4.csv')
Pat_data = df1.values[:,0]  
Pat_data = Pat_data[1:]              # slicing of unusable values
Pat_size1 = Pat_data.size            # gettting the size of Data point we are using 
