...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  6 11:51:56 2019

@author: kendalljohnson
"""

# The file that uses Sensor data with training data to be calc Using machine learning for the Heart of an opionid 
print('Uses Sensor data with training data to be calculated using machine learning for the Heart Rate of an opioid rehab patient')
...
IBI = np.array(IBI)                    # put into Numpy Array
IBI = pd.DataFrame(IBI)                # put into DataFrame
SDNN = np.array(SDNN)                  # put into Numpy Array
SDNN = pd.DataFrame([SDNN])            # put into DataFrame
pNN20 = np.array(pNN20)                # put into Numpy Array
pNN20 = pd.DataFrame([pNN20])          # put into DataFrame
pNN50 = np.array(pNN50)                # put into Numpy Array
pNN50 = pd.DataFrame([pNN50])          # put into DataFrame
