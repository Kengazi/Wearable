...
preNN50 = np.array([],dtype=float)
preNN20 = np.array([],dtype=float)
...
# Gettin NN50
NN50 = np.array([],dtype=float)
for i in range(HRs_size-1):
    if np.abs(preNN50[i])>50:
        np.append(NN50,preNN50[i])
        
# Getting pNN50     
pNN50 = (len(NN50))/(len(preNN50))*100
pNN50 = float(pNN50)
# Gettin NN20
NN20 = np.array([],dtype=float)
for i in range(HRs_size-1):
    if np.abs(preNN20[i])>20:
        np.append(NN20,preNN20[i])
