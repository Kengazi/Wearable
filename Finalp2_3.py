...
#clf = MLPClassifier(solver='lbfgs', alpha=1e-4, hidden_layer_sizes=(10,10,10,8), random_state=1) # 100
clf = MLPClassifier(activation='relu',solver='lbfgs', alpha=1e-4, hidden_layer_sizes=(10,10,11), random_state=1) # 100
